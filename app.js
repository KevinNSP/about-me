...
var correctNumberOfAnswers = 0;

var confirmQuiz = confirm('Your going to take a quiz. Now.');
...
for (var i = 0; i < 6; i++){
  ...
  console.log(quizResponseSeven);
  if (correctState.includes(quizResponseSeven)){
    confirm('Thats 1, try to pick another');
    correctNumberOfAnswers++;
  } else if (quizResponseSeven < correctState){
    alert('Nope! Never been there. Guess again.');
  }
}
